package com.example.oasisapp.Adapters;
...
public class LocationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LocationAdapter(Activity activity, ArrayList<Location> locations, itemClickRV listener){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Location location = getIem(position);
    ...
    private Location getIem(int position){
